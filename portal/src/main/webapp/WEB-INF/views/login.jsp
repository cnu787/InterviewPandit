...
<body>
	...
	<div class="non-authentic-body">
		<div class="container">
			...
			<form id="loginForm" action="individualLoginCheck.do" method="post"
				autocomplete="off">
								...
								<div class="form-group">
									...
									<div class="input-group">
										<input type="text" class="form-control" id="j_username"
											name="j_username" placeholder="Email Id" maxlength="50">
								...
								<div class="form-group">
									...
									<div class="input-group">
										<input type="password" class="form-control" id="j_password"
											name="j_password" placeholder="Password" maxlength="15">
										<div class="input-group-addon">
