	...
	<div class="" style="margin-top: 20px;">
		<div class="container">
			...
			<div class="row">
				...
				<div class="col-xs-11 col-xs-push-1 col-sm-3 col-md-3">
					<!-- <img class="img-responsive" src="resources/images/discount_coupon.png"> -->
				</div>
			</div>
			...
			<div class="row">
				<div class="col-xs-12 col-sm-3 col-sm-push-6 col-md-3 col-md-push-6">
					<div class="form-group">
						<a href="tmiAdmCallCenterRepresentativeLanding.do"><button
								type="button" class="form-control mybackbtn" id="back">
								<!-- Back To Interview -->
								Go to Home
							</button></a>
					</div>
				...
				<div class="col-xs-12 col-sm-3 col-sm-push-6 col-md-3 col-md-push-6">
					<div class="form-group">
						<a href="tmiAdmininterviewBooking.do"><button type="button"
