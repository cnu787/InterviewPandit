...
<script>
	...
	function allAplicantBookedInterviews() {
		var evaluatorName = $('#enterString').val();
		var dashboard = $('#dashboard').val();		
		$(".allapplicant_interviews").load(
				"tmiAdmAllAplicantBookedInterviewsBasedonSearch", {
...
td,th {
	...
	width: -1em;
	text-wrap: none;
	white-space: -moz-pre-wrap !ienterStringmportant; /* Mozilla, since 1999 */
	...
	<div class="" style="margin-top: 20px;">
		<div class="container">
			<div
				...
				<form id="dashboardsearch" action="javascript:allAplicantBookedInterviews()"
			...
			<div class="allapplicant_interviews"></div>
		</div>
	</div>
