...
<body>
	<div class="" style="margin-top: 20px;">
		<div class="container">
			...
			<hr>
			<form id="makePayment" action="paymentSuccess.do" method="post">
				<input type="hidden" name="myToken" value='${myToken}' /> <input
						...
						<div class="row">
							...
							<div class="col-xs-12 col-sm-8 col-md-8">
								<label style="color: #0095DA;">RS. ${actualAmount}
									(Including Service tax 14%)</label> <br>
				...
				<input type="hidden" name="interviewId" id="interviewId"
					value="${interviewId}"> <input type="hidden"
					name="_dontcare">
				<div class="row">
					<div class="col-xs-6 col-sm-3 col-sm-push-6 col-md-2 col-md-push-6">
					...
					<div class="col-xs-6 col-sm-3 col-sm-push-6 col-md-2 col-md-push-6">
						<div class="form-group">
							<button id="continue" type="submit"
								class="form-control mycontinuebtn">Book Interview</button>
						</div>
					</div>
				</div>
			</form>
	...
	<script src="resources/js/admininterviewSummary.js"></script>
