...
@media ( min-width : 420px) and (max-width: 500px) {
	control {
		padding-right: 160.5px !important;
		padding-right-value: 160.5px !important;
		padding-right-ltr-source: physical !important;
		padding-right-rtl-source: physical !important;
	}
}
</style>
<body>
	...
	<div class="non-authentic-body">
		<div class="container">
			<div
				...
				<h4>Register to create Evaluator Account</h4>
				<br>
				<div>
				...
				<div class="row marginauto">
					<div class="col-md-6 col-md-offset-3 myform-body centered">
						...
						<input type="hidden" id="chooseyourRole" name="chooseyourRole"
							value="${usertypelkp[1].usertypeid}" />
						<div class="row">
							<div class="col-sm-6 col-md-6">								
								<div class="form-group">
							...
							<div class="col-xs-12 col-sm-12 col-md-12">								
								<div class="form-group">
									...
									<input type="tel" class="form-control" name="phoneNumber"
										id="phoneNumber" maxlength="24"> <input type="hidden"
