		...
		<div class="container">
			<div class="form-group"
				...
				<h5 class="profile-text" style="color: #0094DA">
					<b>What is Interview Pandit?</b>
				</h5>
				Interview Pandit is India's largest platform that conducts
				...
				Interview Pandit's invites evaluators from the corporate domain, to conduct
				...
				roles in the corporate sector across the verticals. Interview Pandit's exhaustive
				...
				<h5 class="profile-text" style="color: #0094DA">
					<b>How to Register For Interview Pandit Mock Interviews?</b>
				</h5>
				...
				<ul class="lines">
					<li>The students and job seekers need to register with our
						website if they wish to utilize our services. Interview Pandit software will
				...
				<h5 class="profile-text" style="color: #0094DA">
					<b>How can the campuses sign up for the Interview Pandit sessions?</b>
				</h5>
				Campuses can also approach us to deliver the mock sessions for their
				students. They can call or write to Interview Pandit initiating discussions. Interview Pandit
				will plan and organise the mock interview series based on the
				individual requirements in terms of skills and verticals.
				<ul class="lines">
					<li>Educational Institutions will have access to Interview Pandit software,
				...
				The principle aim of Interview Pandit is to offer effective interview practices
				...
				applies to the job seekers who approach Interview Pandit for personalised
				guidance with mock interview sessions.
				<h5 class="profile-text" style="color: #0094DA">
					<b>What are the timelines for conducting mock interviews?</b>
				</h5>
				Interview Pandit conducts the mock interview series for students at the campuses
				...
				At Interview Pandit, all the guidance and training with mock interviews is done
				...
				job interviews.
				<h5 class="profile-text" style="color: #0094DA">
					<b>Does Interview Pandit guarantee a job placement?</b>
				</h5>
				No, we do not. Interview Pandit only enables the students and job seekers to face
				...
				Yes, due intimation should be given to the Interview Pandit team in order to
				process the cancellation request. Please note that amount will not
				be refunded for the same.
				<h5 class="profile-text" style="color: #0094DA">
					<b>What happens when Interview Pandit cancels the interview sessions due to
