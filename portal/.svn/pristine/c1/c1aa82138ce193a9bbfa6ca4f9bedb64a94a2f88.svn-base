		...
		<div class="container">
			<form id="feedBackform" action="#" autocomplete="off">
				...
				<input type="hidden" name="interviewId" id="interviewId"
					...
					name="feedbackDone" id="feedbackDone">
				<div class="row">
					<div class="col-md-9">
						...
						<c:forEach var="knowLst" items="${interviewDetailsKnowledge}">
							...
							<div class="row">
								...
								<input type="hidden" name="educationalId_${j}"
									id="educationalId_${j}" value="${knowLst.feedbacksubsectionid}">
				...
				<div
					class="col-xs-12 col-xs-push-0 col-sm-2 col-sm-push-4 col-md-2 col-md-push-3">
					<div class="form-group">
						<button type="button" class="form-control mybackbtn"
							data-dismiss="modal" id="back">Close</button>
					</div>
				</div>
				<div
					class="col-xs-12 col-xs-push-0 col-sm-2 col-sm-push-4 col-md-2 col-md-push-3">
